...
{
    public class DiagramItemWhileLoop: ItemWithLoop
    {
        public ItemPartOutput trueEnding = null;

        public DiagramItemWhileLoop()
        {
        ...
        protected void RecalculateBranchEndings(RectangleAnchored rectTrue, ItemPartOutput lastTrue)
        {
            ...
            BorderRight = trueEnding.X + rectTrue.RightSideWidth + 16;
            BorderLeft = trueEnding.X - rectTrue.LeftSideWidth - 16;
        }
