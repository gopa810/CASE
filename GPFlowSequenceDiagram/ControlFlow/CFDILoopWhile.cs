...
{
    public class CFDILoopWhile: CFDILoopBase
    {
        ...
        public CFDILoopWhile(DiagramElement parent): base(parent)
        {
        ...
        public override SizeF DE_DrawShape(DiagramDrawingContext ctx, HighlightType highType)
        {
            ...
            UsedRectangle = new RectangleF(OriginPoint.X - box.Width/2 - 32, OriginPoint.Y,
                box.Width + 64, EndPoint.Y - OriginPoint.Y);
            ...
            g.DrawString("loop", DrawProperties.fontSmallTitles, Brushes.Black, OriginPoint.X + 6, OriginPoint.Y);
